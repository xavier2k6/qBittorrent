...
BaseLogModel::BaseLogModel(QObject *parent)
    ...
    , m_timeForeground(UIThemeManager::instance()->getColor(u"Log.TimeStamp"_qs, QColorConstants::Svg::grey))
{
}
...
LogMessageModel::LogMessageModel(QObject *parent)
    ...
    {
        {Log::NORMAL, UIThemeManager::instance()->getColor(u"Log.Normal"_qs, QColorConstants::Svg::green)},
        {Log::INFO, UIThemeManager::instance()->getColor(u"Log.Info"_qs, QColorConstants::Svg::royalblue)},
